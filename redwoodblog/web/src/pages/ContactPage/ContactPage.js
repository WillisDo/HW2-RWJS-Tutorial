...
import {FieldError, FormError, Label,Form,TextField,TextAreaField,Submit, useForm} from '@redwoodjs/forms'
...
const ContactPage = () => {
  ...
  const [create, { loading, error }] = useMutation(CREATE_CONTACT, {onCompleted: () => {toast.success('Thank You'), formMethods.reset()}, })
  const onSubmit = (data) => {
